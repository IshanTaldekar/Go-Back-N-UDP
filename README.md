...
The program has been thoroughly tested and performs to the specifications. It is able to handle upto 90% (the maximum drop rate) of the packets being lost in transit.
